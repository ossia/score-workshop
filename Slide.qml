...
Item {
    ...
    property real fontSize: presentation.height * 0.05
    property real fontScale: presentation.fontScale
    ...
    property real masterWidth: presentation.width
    property real masterHeight: presentation.height

    property color titleColor: presentation.titleColor;
    property color textColor: presentation.textColor;
    property string fontFamily: presentation.fontFamily;
    property int textFormat: Text.PlainText

    visible: false
    layer.enabled: true
    layer.sourceRect: Qt.rect(-x, -y, presentation.width, presentation.height)
